...
export default function Footer() {
  return (
    <>
      {/* Main Footer Section */}
      <footer className="bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800 py-8 sm:py-12 relative border-t border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 md:px-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
      ...
      <div className="fixed bottom-4 sm:bottom-6 left-4 sm:left-6 flex flex-col gap-2 sm:gap-3 z-50">
        {/* WhatsApp */}
        <a
          href="https://wa.me/918989889880"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-green-500 hover:bg-green-600 text-white rounded-full p-3 sm:p-4 shadow-lg transition transform hover:scale-110"
        ...
        <a
          href="tel:+918989889880"
          className="bg-sky-500 hover:bg-sky-600 text-white rounded-full p-3 sm:p-4 shadow-lg transition transform hover:scale-110"
          aria-label="Call Now"
        >
