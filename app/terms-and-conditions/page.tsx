...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-700 space-y-4">
      ...
      <p>
        Welcome to <strong>KitchenKettles.com</strong>, owned and operated by{" "}
        <strong>4C Group</strong>. By accessing our website or purchasing from
      ...
      <p>
        ...
        policies. “You” refers to the user, and “We” refers to Kitchen Kettles.
      </p>
      ...
      <p>
        Kitchen Kettles is not liable for indirect or incidental damages arising
      ...
      <p>
        ...
        Phone: +91-8989889880
        <br />
        Address: Kitchen Kettles, 305, Shop No. 9, Gunjur Varthur Main Road,
