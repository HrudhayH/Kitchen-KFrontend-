          ...
          <div className="bg-white p-3 sm:p-4 rounded shadow">
            ...
            <div className="space-y-3 sm:space-y-4">
              {items.map((it) => (
                <div
                  key={it.id}
                  className="flex items-start sm:items-center justify-between gap-3 sm:gap-4 flex-col sm:flex-row"
                >
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-4 w-full sm:w-auto">
                    <QuantitySelector
                      value={it.qty || 0}
                      onChange={(newQty) => handleQuantityChange(it.id, newQty)}
                      size="sm"
                    />
        ...
        <div>
          <div className="bg-white p-4 sm:p-6 rounded shadow space-y-3 sm:space-y-4">
            ...
            <button
              ...
              className="w-full bg-emerald-600 text-white py-2 rounded text-sm sm:text-base hover:bg-emerald-700 transition"
            >
              Proceed to Checkout
            </button>
            ...
            <button
              ...
              className="w-full border mt-2 py-2 rounded text-red-600 text-sm sm:text-base hover:bg-red-50 transition"
            >
              Clear Cart
            </button>
          </div>
