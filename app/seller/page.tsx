...
export default function SellerDashboard() {
  ...
  const stats = [
    { title: 'My Products', value: '0', icon: Package, color: 'bg-blue-100 text-blue-600' },
    { title: 'Total Sales', value: '0', icon: ShoppingCart, color: 'bg-emerald-100 text-emerald-600' },
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-16">
                ...
                <p className="text-slate-600 mb-6">Start adding products to your inventory</p>
                <Button>
