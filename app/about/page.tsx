        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl font-bold text-slate-900 mb-6">
              About Kitchen Kettels
            </h1>
            <p className="text-xl text-slate-600">
              Your trusted partner in creating exceptional culinary experiences
              through quality kitchen tools.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-slate-600">
              <p className="mb-4">
                Founded with a passion for quality and innovation, Kitchen
                Kettels has become a leading destination for home chefs and
                cooking enthusiasts seeking premium kitchen utensils and
                cookware.
              </p>
              <p className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-600">
                We partner with the best brands to ensure every product meets
                our high standards.
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                We constantly update our catalog with the latest innovations in
                kitchen technology.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Our team of culinary experts is passionate about helping you
                cook better.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-12 text-center">
            ...
            <p className="text-lg text-slate-600 mb-8">
              Become part of a growing community of cooking enthusiasts who
              trust Kitchen Kettels for their culinary needs.
            </p>
          </div>
        </div>
      </section>
